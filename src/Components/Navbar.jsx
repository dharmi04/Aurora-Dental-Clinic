...
const Navbar = () => {
  ...
  return (
    <nav className=" items-center justify-between pl-8 pr-8 pt-4">
      {/* <div className="flex items-center w-1/2 pl-4">
        <img src={logo} alt="Aurora Dental Logo" className="h-20 w-30" />
      </div> */}
      <div className="flex items-center space-x-8  justify-center">
        <a href="/" className="text-white text-xs md:text-xl hover:text-green-500">Home</a>
        <a href="/aboutus" className="text-white text-xs md:text-xl hover:text-green-500">About Us</a>
        <a href="#about-us" className="text-white text-xs md:text-xl hover:text-green-500">Our Team</a>
        <a href="#reviews" className="text-white text-xs md:text-xl hover:text-green-500">Reviews</a>
        <a href="#contact" className="text-white text-xs md:text-xl hover:text-green-500">Contact</a>
