  ...
  return (
    <nav className="flex items-center justify-between pl-8 pr-8 pt-4">
      ...
      <div className="hidden md:flex items-center space-x-8 w-1/2 justify-end pr-10">
        <a href="#home" className="text-white text-sm hover:text-green-500">Home</a>
        <a href="#about-us" className="text-white text-sm hover:text-green-500">About Us</a>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-16 left-0 w-full bg-gray-800 flex flex-col items-center space-y-4 py-4">
          <a href="#home" className="text-white text-sm hover:text-green-500" onClick={toggleMobileMenu}>Home</a>
          <a href="#about-us" className="text-white text-sm hover:text-green-500" onClick={toggleMobileMenu}>About Us</a>
